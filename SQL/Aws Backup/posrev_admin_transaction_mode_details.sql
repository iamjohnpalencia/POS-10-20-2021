...
--
-- Table structure for table `admin_transaction_mode_details`
--

DROP TABLE IF EXISTS `admin_transaction_mode_details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `admin_transaction_mode_details` (
...
--
-- Dumping data for table `admin_transaction_mode_details`
--

LOCK TABLES `admin_transaction_mode_details` WRITE;
/*!40000 ALTER TABLE `admin_transaction_mode_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `admin_transaction_mode_details` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-08-06  9:18:22
