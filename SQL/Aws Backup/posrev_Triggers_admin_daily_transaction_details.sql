...
--
-- Table structure for table `Triggers_admin_daily_transaction_details`
--

DROP TABLE IF EXISTS `Triggers_admin_daily_transaction_details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `Triggers_admin_daily_transaction_details` (
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`masteradmin`@`%`*/ /*!50003 TRIGGER `CopyTo_Admin_Daily_Transaction_Details` AFTER INSERT ON `Triggers_admin_daily_transaction_details` FOR EACH ROW INSERT INTO admin_daily_transaction_details(`loc_details_id`, `product_id`, `product_sku`, `product_name`, `quantity`, `price`, `total`, `crew_id`, `transaction_number`, `active`, `created_at`, `guid`, `store_id`, `total_cost_of_goods`, `product_category`, `zreading`,`transaction_type`)
SELECT `loc_details_id`, `product_id`, `product_sku`, `product_name`, `quantity`, `price`, `total`, `crew_id`, `transaction_number`, `active`, `created_at`, `guid`, `store_id`, `total_cost_of_goods`, `product_category`, `zreading` ,`transaction_type`
  FROM Triggers_admin_daily_transaction_details
 WHERE NOT EXISTS(SELECT `loc_details_id`, `product_id`, `product_sku`, `product_name`, `quantity`, `price`, `total`, `crew_id`, `transaction_number`, `active`, `created_at`, `guid`, `store_id`, `total_cost_of_goods`, `product_category`, `zreading`,`transaction_type`
                    FROM admin_daily_transaction_details
                   WHERE transaction_number = Triggers_admin_daily_transaction_details.transaction_number AND loc_details_id = Triggers_admin_daily_transaction_details.loc_details_id AND store_id = Triggers_admin_daily_transaction_details.store_id AND guid = Triggers_admin_daily_transaction_details.guid) */;;
DELIMITER ;
...
-- Dump completed on 2021-08-06  9:18:23
